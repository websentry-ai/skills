...
2. **Apply Project Standards**: Follow the established coding standards from the project's CLAUDE.md or equivalent configuration, including:
   - Consistent import ordering and module style
   - Idiomatic patterns for the language/framework in use
